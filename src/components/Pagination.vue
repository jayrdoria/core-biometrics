<template>
	<div class="flex items-center">
		<div class="text-14 core-text-accent-2 q-mr-md md">Rows</div>
		<div>
			<q-select
				borderless
				v-model="selectedRow"
		...
		<div class="core-pagination-container flex justify-center items-center">
			<q-pagination
				...
				@update:model-value="updatePagination()"
			/>
			<div class="core-pagination-select-input text-no-wrap">
				<q-select

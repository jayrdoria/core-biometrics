...
/**
 * A request that is used to fetch all or numbers from database
 *
 * @returns Array
 */
...
const FetchORNumbers = () => {
	return new Promise((resolve, reject) => {
		httpGet(`polanguiTreasury/orNumbers`, {
			success(response) {
...
/**
 * A request that is used to fetch a specific or number from database
 *
 * @returns Array
 */

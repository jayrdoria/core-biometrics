<template>
	<div>
		<q-header class="core-header core-bg-secondary">
			<div>
				<MobileHeader />
				<!-- <div class="mobile-view row items-center justify-between q-px-md">
        <div><q-icon class="cursor-pointer core-text-primary text-hover-accent-0 opacity-7 q-my-lg" size="sm" name="iconfont icon-arrow-left" /></div>
        <div class="text-23">User Management</div>
        <div><q-icon class="cursor-pointer core-text-primary text-hover-accent-0 opacity-7" size="sm" name="iconfont icon-add" /></div>
        </div> -->
					...
					<div class="col-8 col-md-5 flex items-center">
						<q-input class="full-width main-search" dense borderless placeholder="Search Filter...">
							<template v-slot:prepend>
								<q-icon class="q-pl-md core-text-accent-0" name="search" />
							</template>
						</q-input>
					</div>
					<div class="col-4 col-md-6">
						<div class="row items-center core-text-accent-0 justify-end">
							<div class="tablet-materials col-auto q-pr-sm">
								<q-icon
									class="core-text-accent-1 text-hover-accent-1 bg-hover-accent-0"
							...
							<div class="tablet-materials col-auto q-pr-sm">
								<q-icon
									class="core-text-accent-1 text-hover-accent-1 bg-hover-accent-0 relative-postion"
							...
							>
								...
								<div class="desktop-materials">
									<q-icon class="q-pa-none core-text-primary" size="sm" name="expand_more" />
								</div>

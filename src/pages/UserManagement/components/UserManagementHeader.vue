<template>
	<div class="row text-center full-width">
		...
		<div class="col-8 text-center">
			<h5 class="header-title q-my-none text-h6 text-bold core-text-accent-1">
				{{ title }}
			</h5>
		</div>
		<div class="col-2">
			<q-icon
				...
				class="bg-amber-4 core-text-accent-1 core-border-radius-8 q-pa-xs fixed top-right-24"
				size="sm"
...
import { ToggleMenuBtnState, ToggleSearchBtnState, ToggleFilterDialogState } from '../../../composables/Triggers';
export default {
	setup() {
